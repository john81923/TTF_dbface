...
class App(object):
    def __init__(self, labelfile, imagesdir, valimgdir):
...
trial_name = "small-UCBA-mbv2-center"
...
app = App('/mnt/sdd/johnnysun/Dataset/All_US_Data/OCR_LP_trainv688/label.txt', '/mnt/sdd/johnnysun/Dataset/All_US_Data/OCR_LP_trainv688/images', '/mnt/sdd/johnnysun/Dataset/All_US_Data/OCR_LP_testv688/images' )
app.train()
