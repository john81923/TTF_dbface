...
class VDataset(Dataset):
    def __init__(self, imagesdir, mean, std):
        ...
        for extension in extlist :
            self.items += glob(f'{imagesdir}/*{extension}')
        self.items = self.items[:1280]
        self.mean = mean
        self.std = std
...
class App(object):
    def __init__(self, labelfile, imagesdir, valimgdir, set_size ):
        ...
        Nameidfile_path = '/mnt/models/CarLicensePlates_Detection_Recognition/ocr/ocr-net.names'
...
trial_name = "small-UCBA-mbv2-WaterMeter_small_128_96_keep09IOU"
...
app = App(  '/mnt/atdata/WaterMeter/WMPlate128_96/train/label.txt',
            '/mnt/atdata/WaterMeter/WMPlate128_96/train/images',
            '/mnt/atdata/WaterMeter/WMPlate128_96/test/images',
            set_size=Set_sizeWH( (128, 96) ) )
app.train()
