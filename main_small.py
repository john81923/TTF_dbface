...
def detect(model, image, threshold=0.3, nms_iou=0.3):
    ...
    for cx, cy, score in zip(xs, ys, scores):
        ...
        objs.append(common.BBox(0, xyrb=xyrb, score=score))
...
def detect_image(model, file):
    ...
    common.imwrite("detect_result/" + common.file_name_no_suffix(file) + ".small.draw.jpg", image)
...
def image_demo():
    ...
    dbface.load("/mnt/sdd/johnnysun/Car_License_DetReg/TTF_OCR-dbface/train/small/151.pth")
    detect_image(dbface, '/mnt/sdd/johnnysun/Car_License_DetReg/license_plate_dbocr/USA_car_lp.png')
